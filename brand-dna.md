...
| 色名 | 色值 | 用途 |
|------|------|------|
| 珊瑚粉 | `#FFA7A6` | 主色调、标题、超链接、重点标记 |
| 鼠尾草绿 | `#D1E5D0` | 强调、装饰、badges、连接线、高亮 |
| 青柠黄绿 | `#E0F0B0` | 点缀、高亮下划线、CTA、标签 |
...
| 类型 | 禁止 |
|------|------|
| 配色 | 蓝紫渐变、cyan、neon、纯黑白、AI常用的冷灰蓝调、任何多色渐变背景（占位色块用纯色 `#FFF8E1` 或 `#D1E5D0`，荷光笔高亮的 `linear-gradient(transparent 60%, #D1E5D0 60%)` 保留） |
