...
<section style="text-align:center; margin-bottom:14px;">
  <span style="font-size:13px; font-weight:bold; letter-spacing:5px; color:#E0F0B0;">标签文字</span>
</section>
```
...
<section style="text-align:center; margin-bottom:10px;">
  <p style="margin:0; font-family:Georgia,'Songti SC',serif; font-size:21px; font-weight:900; line-height:1.9;">金句文字<br>第二行<span style="color:#FFA7A6;">蓝色关键词</span>。</p>
</section>
```
...
<section style="text-align:center; margin-bottom:36px;">
  <span style="display:inline-block; width:36px; height:4px; background:#FFA7A6; border-radius:2px;"></span>
  <span style="display:inline-block; width:18px; height:4px; background:#D1E5D0; border-radius:2px; margin-left:5px;"></span>
  <span style="display:inline-block; width:8px; height:4px; background:#E0F0B0; border-radius:2px; margin-left:5px;"></span>
</section>
```
...
<section style="margin-bottom:52px;">
  ...
  <section style="margin-bottom:22px;">
    <span style="display:inline-block; width:56px; height:6px; background:#D1E5D0; border-radius:3px;"></span>
  </section>
  <!-- 正文内容 -->
...
<section style="margin-bottom:52px;">
  ...
  <section style="margin-bottom:4px;">
    <span style="font-size:13px; font-weight:bold; letter-spacing:4px; color:#FFA7A6;">STEP 1</span>
  </section>
  <section style="margin-bottom:10px;">
...
### 荧光笔高亮（加粗文字）
```html
<span style="background:linear-gradient(transparent 60%, #D1E5D0 60%); font-weight:bold; padding:0 2px;">高亮文字</span>
```
...
<section style="text-align:center; padding:20px 0 0;">
  ...
  <p style="margin:0 0 4px; font-size:15px; font-weight:bold; color:#1A1A2E;">Aviva</p>
  <p style="margin:0; font-size:13px; color:#8A8A9A; line-height:1.8;">中国电信佘山支局 · 客户经理<br>甜酷元气 · 温柔有力</p>
</section>
```
